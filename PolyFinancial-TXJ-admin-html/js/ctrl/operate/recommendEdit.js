app.controller("recommendEditCtrl",function ($scope,$http,$state,serviceHTTP,$stateParams) {
    var vm = this;
    ...
    if(id == 0){
        ...
        serviceHTTP.recommendHTTP(list).then(function successCallback(response) {
            // 请求成功执行代码
